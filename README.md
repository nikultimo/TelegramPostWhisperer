...
- **Видео** — загрузка видео файлов через диалог. Можно загрузить несколько видео, которые будут отправлены как **media group**.
  - Если выбрана опция "Отправить текст как подпись к первой фотографии", текст также будет использован как подпись к первому видео.
...
- `--video` — можно указать несколько раз. При отправке нескольких видео они объединяются в media group.
